...
const char* sz_m_mhsaa_misca [5][8] = {
    ...
    {  NULL,  "23.69", "51.79",   "1:55.29", NULL,    "5:14.71", NULL,    NULL   },  // free
    {  NULL,  NULL,    "1:01.39", NULL,      NULL,    NULL,      NULL,    NULL   },  // back
    {  NULL,  NULL,    "1:07.89", NULL,      NULL,    NULL,      NULL,    NULL   },  // breast
    {  NULL,  NULL,    "58.89",   NULL,      NULL,    NULL,      NULL,    NULL   },  // fly
    {  NULL,  NULL,    NULL,      "2:12.09", NULL,    NULL,      NULL,    NULL   }   // IM
};
...
const char* sz_w_mhsaa_misca [5][8] = {
    // 25     50       100        200        400      500        1000     1650
    {  NULL,  "26.69", "58.29",   "2:06.29", NULL,    "5:40.29", NULL,    NULL   },  // free
    {  NULL,  NULL,    "1:06.99", NULL,      NULL,    NULL,      NULL,    NULL   },  // back
    {  NULL,  NULL,    "1:15.39", NULL,      NULL,    NULL,      NULL,    NULL   },  // breast
    {  NULL,  NULL,    "1:05.29",   NULL,      NULL,    NULL,      NULL,    NULL   },  // fly
    {  NULL,  NULL,    NULL,      "2:24.69", NULL,    NULL,      NULL,    NULL   }   // IM
};

/* TODO - These are currently boys times */
const char* sz_w_mhsaa_state [5][8] = {
    // 25     50       100        200        400      500        1000     1650
    {  NULL,  "22.69", "49.59",   "1:48.79", NULL,    "4:57.79", NULL,    NULL   },  // free
    {  NULL,  NULL,    "56.69",   NULL,      NULL,    NULL,      NULL,    NULL   },  // back
    {  NULL,  NULL,    "1:02.89", NULL,      NULL,    NULL,      NULL,    NULL   },  // breast
...
typedef const char * qual_array [5][8];

static const char (* (getQ2QualifyingTimes)(int age, bool bBoy))[5][8] {
    if (age <= 10) {
        if (bBoy) {
            return sz_nine_ten_m_q2;
        } else {
            return (const char *)sz_nine_ten_w_q2;
        }
    } else if (age <= 12) {
        if (bBoy) {
            return (const char *)sz_eleven_twelve_m_q2;
        } else {
            return (const char *)sz_eleven_twelve_w_q2;
        }
    } else if (age <= 14) {
        if (bBoy) {
            return (const char *)sz_thirteen_fourteen_m_q2;
        } else {
            return (const char *)sz_thirteen_fourteen_w_q2;
        }
    } else { // 'Open' age group
        if (bBoy) {
            return (const char *)sz_fifteen_eighteen_m_q2;
        } else {
            return (const char *)sz_fifteen_eighteen_w_q2;
        }
    }
}
...
+(NSString*) getJoCutWithAge:(NSDate*)dob distance:(int)distance stroke:(int) stroke gender:(NSString*)gender
{
    ...
    bool bBoy = [gender isEqualToString:@"m"];
...
+(NSString*) getTimeStandardForMHSAAWithDistance:(int)distance stroke:(int)stroke gender:(NSString*)gender time:(float)time
{
    ...
    assert(distanceidx < 8);
    
    if ([gender isEqualToString:@"m"]) {
        memcpy(sz_misca,sz_m_mhsaa_misca,sizeof(sz_misca));
        memcpy(sz_state,sz_m_mhsaa_state,sizeof(sz_state));
    } else {
        memcpy(sz_misca,sz_w_mhsaa_misca,sizeof(sz_misca));
        memcpy(sz_state,sz_w_mhsaa_state,sizeof(sz_state));
    }
    if (sz_state != NULL) {
        float fState = [TimeStandard getFloatTimeFromCStringTime:sz_state[stroke-1][distanceidx]];
        float fMISCA = [TimeStandard getFloatTimeFromCStringTime:sz_misca[stroke-1][distanceidx]];
        if (time <= fState) {
            return @"STATE";
        }
        else if (time <= fMISCA) {
            return [NSString stringWithFormat:@"MISCA (ST+%2.2f)",time-fState];
        }
    }
