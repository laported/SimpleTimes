...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    NSLog(@"TopTimes: %d times",[_races count]);
    return [_races count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RaceResult *race = [_races objectAtIndex:indexPath.row];
    ...
    NSString *timestd = [TimeStandard getTimeStandardWithAge:[_athlete ageAtDate:race.date] distance:[race.distance intValue] stroke:nStroke gender:_athlete.gender time:ftime];
...
- (void) setAthlete:(AthleteCD *)a
{
    _athlete = a;
    [_races release];
    _races = [[_athlete personalBests] retain]; 
